...
export function SessionReportModal({
  ...
  return (
    ...
    >
      <div className="ts-report-modal w-full max-w-2xl rounded-t-2xl bg-white p-4 shadow-2xl sm:rounded-2xl sm:p-6">
        ...
        <div className="mt-5 flex justify-end">
          <button
            type="button"
            className="ts-button ts-button-default rounded-md px-4 py-2 text-sm font-medium text-white"
            onClick={onClose}
          >
            Done
          </button>
